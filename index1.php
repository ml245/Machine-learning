...
-->   
        ...
        <div id="home" class="upload-hero" style="background-image: url(C:\xampp\htdocs\ML\assets\images\b.jpg)">
            <br><br><br>
...
-->
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url(C:\xampp\htdocs\ML\b.jpg)">
        <div class="footer-shape">
            <img src="../assets/images/shape/footer-shape.png" alt="footer shape">
        </div> <!-- footer shape -->
        <div class="container">
            <div class="footer-copyright text-center">
                <p class="text">© Created by Algorithms All Rights Reserved.</p>
